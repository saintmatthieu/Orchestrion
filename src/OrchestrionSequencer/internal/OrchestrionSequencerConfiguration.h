...
private:
  ...
  OrnamentMode ornamentMode() const override;
  void setOrnamentMode(OrnamentMode) override;
  muse::async::Notification ornamentModeChanged() const override;
  ...
  muse::async::Notification m_ornamentModeChanged;
};
} // namespace dgk
