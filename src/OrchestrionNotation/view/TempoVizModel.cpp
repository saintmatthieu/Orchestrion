...
void TempoVizModel::addTempoSample(double tMs,
                                   const std::vector<HandTempo> &hands)
{
  _latestMs = tMs;
...
void TempoVizModel::addOnset(double tMs, int staff)
{
...
void TempoVizModel::setSmoothedCurve(int staff,
