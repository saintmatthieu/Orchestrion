        ...
        &managers)
{
  muse::ui::UiActionList actions{
      ...
      muse::ui::UiAction("orchestrion-advanced-toggle-note-info",
                         mu::context::UiCtxAny, mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::loopIn, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::loopOut, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      ...
      muse::ui::UiAction("orchestrion-advanced-toggle-persistent-timing-marks",
                         mu::context::UiCtxAny, mu::context::CTX_ANY),
      muse::ui::UiAction("orchestrion-advanced-toggle-hand-sync-score",
                         mu::context::UiCtxAny, mu::context::CTX_ANY),
      muse::ui::UiAction("orchestrion-advanced-toggle-dynamics-score",
                         mu::context::UiCtxAny, mu::context::CTX_ANY),
      ...
      muse::ui::UiAction(actionIds::autoPlayLeftHand, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::autoPlayRightHand, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction("orchestrion-advanced-toggle-proportional-spacing",
                         mu::context::UiCtxAny, mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::playbackToggle, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      ...
      muse::ui::UiAction(actionIds::playModeFittedTempo, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::playModeMetronome, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::ornamentsDisabled, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::ornamentsManual, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::ornamentsAutomatic, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::addEffect, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::removeEffect, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::editEffect, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction("view-toggle-fullscreen", mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::toggleMidiKeyboardIcon,
                         mu::context::UiCtxAny, mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::togglePedalIndicator, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::setGoldTheme, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
      muse::ui::UiAction(actionIds::setSilverTheme, mu::context::UiCtxAny,
                         mu::context::CTX_ANY),
