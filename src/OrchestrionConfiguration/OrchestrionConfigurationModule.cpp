...
namespace dgk
{
OrchestrionConfigurationModule::OrchestrionConfigurationModule()
    : m_configuration(std::make_shared<OrchestrionConfiguration>())
{
}

std::string OrchestrionConfigurationModule::moduleName() const
{
