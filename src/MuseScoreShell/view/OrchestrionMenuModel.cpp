...
muse::uicomponents::MenuItem *OrchestrionMenuModel::makeFileMenu()
{
  const QList<muse::uicomponents::MenuItem *> menu{
      makeMenuItem(
          ...
          muse::TranslatableString("appshell/menu/file", u"&From computer…")),
      makeMenuItem(
          "orchestrion-file-open-example",
          muse::TranslatableString("appshell/menu/file", u"&Example file…")),
      makeSeparator(),
      ...
      makeMenuItem("orchestrion-file-help",
                   muse::TranslatableString("appshell/menu/file", u"&Help…"))};
