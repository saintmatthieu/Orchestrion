...
- **Quitting**: window close / Cmd+Q goes through `OrchestrionActionController::closeProjectBeforeQuit`, which closes the project itself (no MuseScore save question: imported scores always count as "needing a save") before the framework tears the context down.
